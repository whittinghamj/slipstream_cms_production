...
# add theme to users
mysql -uslipstream -padmin1372 -e "ALTER TABLE slipstream_cms.users ADD COLUMN IF NOT EXISTS \`theme\` VARCHAR(20) DEFAULT 'blue'; "; >> $LOG
